...
class AllJobs extends Component {
  ...
  onGetProfileDetails = async () => {
    ...
    const profileAriUrl = 'https://apis.ccbp.in/profile'
    ...
    const responseProfile = await fetch(profileAriUrl, profileOptions)
  ...
  onGetJobDetails = async () => {
    ...
    const responseJobs = await fetch(jobsApiUrl, jobOptions)
